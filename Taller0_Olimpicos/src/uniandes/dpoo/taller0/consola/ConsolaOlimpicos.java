...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		String nombreAtleta = input("Ingrese el nombre del atleta: ");
		
		Pais pais= calculadora.buscarPaisAtleta(nombreAtleta);
		
		String nombrePais = pais.darNombre();
		
		System.out.println(nombreAtleta + "representa a " + nombrePais);
	}
